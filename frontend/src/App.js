        ...
        <Router>
            <div style={styles.container}>
                ...
                <nav style={styles.nav}>
                    ...
                    <CustomNavLink to="/streamlit">Streamlit</CustomNavLink> {/* Add this link for Streamlit */}
                </nav>
                ...
                <Routes>
                    ...
                    {/* Add the Streamlit page route */}
                    <Route path="/streamlit" element={<StreamlitPage />} /> {/* This is the new route */}
                </Routes>
            </div>
        </Router>
    );
...
const StreamlitPage = () => {
    return (
        <div>
            <iframe
                title="Streamlit App"
                src="http://localhost:8501" // URL of your locally running Streamlit app
                width="100%"
                height="1000px"
                frameBorder="0"
                style={{ border: 'none' }}
